...
type Category = { id:number; code:number; name:string; description:string|null }
...
export default function CategoriesPage(){
  ...
  return (
    <main style={{padding:24}}>
      <h1 style={{marginBottom:16}}>Κατηγορίες</h1>
      ...
      <div style={{display:'grid', gridTemplateColumns:'120px 1fr 1fr 120px', gap:8, alignItems:'end', maxWidth:900}}>
        ...
        <div>
          <label>Όνομα</label>
          <input value={name} onChange={e=>setName(e.target.value)} placeholder="Κάμερες Αναλογικές"
                 style={{width:'100%', padding:8, border:'1px solid #ccc'}} />
        </div>
        <div>
